...
public class WaitingFragment extends Fragment implements ListOfProductsAdapter.OnNoteListener {

    private static final String TAG = "WaitingOrdersFragment";
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        swipeRefreshLayout = (SwipeRefreshLayout) view.findViewById(R.id.swipe_up_refresh_wait);
    ...
    public void getProductList() {
        ...
        call = apiService.listOfProductsCouriers();
