package com.example.asus.mobiletracker.courierSide.adapters;
...
public class ListOfProductsAdapter2 extends RecyclerView.Adapter<ListOfProductsAdapter2.MyViewHolder>{

    private final static String TAG = "ListOfProducts2";
    ...
    public ListOfProductsAdapter2(List<Products> postList, Context context, OnNoteListener onNoteListener) {
